...
const Splash = (props) => {
    return (
        <div id='Splash'>
          ...
          <p>ReactJack 21 is an online web app created using React.JS, CSS, and the <a href='http://deckofcardsapi.com/' target='_blank' rel="noopener noreferrer">Deck of Cards API</a></p>
